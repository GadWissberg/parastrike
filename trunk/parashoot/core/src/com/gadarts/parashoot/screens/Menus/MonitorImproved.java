...
public class MonitorImproved extends Table {
    ...
    private Texture scanLineTexture = Main.getAssetsManager().get(Assets.GFX.Images.Menus.SCAN_LINES);
    ...
    private void createHeader(String header) {
        ...
        BitmapFont font = Main.getAssetsManager().get(Rules.System.FontsParameters.ArmyFontNames.BIG, BitmapFont.class);
    ...
    private ButtonClickImproved defineBackButtonClick() {
        return new ButtonClickImproved() {
            ...
            public void clicked(InputEvent event, float x, float y) {
                ...
                Main.getInstance().goToMenuScreen(parentScreen.getBackScreen());
            }
        };
    }
    ...
    public void setActivation(boolean activation) {
        ...
        Main.getSoundPlayer().playSound(SFX.HUD.PAUSE_MENU_MOVES, false, false);
    }
