...
public class IntroScreen extends BasicMenuScreen {
    ...
    public IntroScreen() {
        super();
        setNextScreen(Main.MenuType.WELCOME);
    }
    ...
    public void show() {
        ...
        logoSprite = new Sprite(Main.getAssetsManager().get(Assets.GFX.Sheets.General.BOTTOM_LOADING_SCREEN_DATA_FILE, TextureAtlas.class).findRegion(Assets.GFX.Sheets.ImagesNames.GADARTS));
    ...
    public static void initializeTutorial() {
        ...
        Main.getAssetsManager().loadDataBattle(Assets.Levels.TUTORIAL_LEVEL_FILE_NAME);
    }
