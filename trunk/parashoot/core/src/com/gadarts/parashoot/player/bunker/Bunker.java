...
public class Bunker extends PlayerCharacter {
    ...
    public Bunker() {
        super();
        atlas = Main.getAssetsManager().get(Assets.GFX.Sheets.InGame.Player.Bunker.DATA_FILE);
    ...
    protected void onDeath() {
        super.onDeath();
        Main.getSoundPlayer().playSound(SFX.Misc.HUGE_EXPLOSION);
    ...
    public void activateShield() {
        ...
        Main.getSoundPlayer().playSound(SFX.Player.Bonus.SHIELD_ACTIVATED);
//        Main.soundPlayer.playSound(Assets.Sfx.Sounds.Taunts.SHIELD_ON, false, false);
    }
    ...
    private final Timer.Task TASK_DEACTIVATE_SHIELD = new Timer.Task() {
        ...
        public void run() {
            ...
            Main.getSoundPlayer().playSound(SFX.Player.Bonus.SHIELD_OFF);
//            Main.soundPlayer.playSound(Assets.Sfx.Sounds.Taunts.SHIELD_OFF, false, false);
        }
    };
    ...
    private final Timer.Task TASK_SHIELD_WARNING = new Timer.Task() {
        ...
        public void run() {
            if (getShieldVisibility()) {
                Main.getSoundPlayer().playSound(SFX.Player.Bonus.SHIELD_DEPLETED);
