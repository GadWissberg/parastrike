...
public class MiscFactory extends ObjectFactory {
    ...
    public Ornament createOrnament(OrnamentAppearance ornamentAppearance, int x, int y) {
        ...
        ornament.init(Main.getAssetsManager().get(Assets.GFX.Sheets.InGame.Misc.Ornaments.DATA_FILE, TextureAtlas.class), ornamentType.getRegion(), x, y, getWarScreenElements(), ornamentType.getSpeed(), ornamentType.getFrameDuration(), ornamentType.getSound(), ornamentType.isFacingDirection());
