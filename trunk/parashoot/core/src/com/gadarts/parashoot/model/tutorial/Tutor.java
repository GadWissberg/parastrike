...
public class Tutor extends WidgetGroup {
    ...
    Image getFinger() {
        if (finger == null) {
            TextureAtlas textureAtlas = Main.getAssetsManager().get(Assets.GFX.Sheets.InGame.HUD_DATA_FILE, TextureAtlas.class);
    ...
    private void createLabel() {
        BitmapFont font = Main.getAssetsManager().get(Rules.System.FontsParameters.RegularFontNames.SMALL);
