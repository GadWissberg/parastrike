...
import com.gadarts.parashoot.screens.Menus.*;
...
public class Main extends Game implements ApplicationListener {
    ...
    public Main(ActionResolver actionResolver, GGSActionResolver ggsActionResolver) {
    ...
    public void create() {
        ...
        if (GameSettings.TEST_MENU_ACTIVE) {
            ...
            Main.getAssetsManager().firstLoad();
...
//        }
    ...
    @Override
    public void dispose() {
        Main.getInstance().actionResolver.EndSession();
        soundPlayer.dispose();
        screen.dispose();
    }
    ...
    public void goToMenuScreen(MenuType type) {
        goToMenuScreen(type, null);
    }

    public void goToMenuScreen(MenuType type, HashMap<String, Integer> additionalInfo) {
        if (type != MenuType.INTRO && !assetsManager.isMenuLoaded()) {
