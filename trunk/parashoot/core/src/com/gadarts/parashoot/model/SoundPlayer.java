...
//            }
    ...
    public void playMusic(SFX.Music musicFile) {
        music = Main.getAssetsManager().get(SFX.fileAttribute.SFX_FOLDER_NAME.getValue() + "/" + musicFile.getParentDir().getValue() + "/" + musicFile.getValue() + "." + musicFile.getFormat().getValue());
