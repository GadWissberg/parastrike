...
public class ScoresHandler {
    ...
    public void addScore(int scoreDelta) {
        ...
        Main.getPlayerStatsHandler().setScore(Main.getPlayerStatsHandler().getScore() + scoreDelta);
    }
    ...
    public void addCoins(int coinsDelta, float x, float y) {
        ...
        Main.getPlayerStatsHandler().setCoins(Main.getPlayerStatsHandler().getCoins() + coinsDelta);
    }
