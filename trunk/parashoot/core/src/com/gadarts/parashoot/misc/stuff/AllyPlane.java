...
public class AllyPlane extends Misc {
    ...
    public AllyPlane() {
        atlas = Main.getAssetsManager().get(Assets.GFX.Sheets.InGame.Player.BONUS_APPENDIX_DATA_FILE);
    }
    ...
    public void init(WarScreenElements mechanics, Factories factories) {
        ...
        motorSound = Main.getSoundPlayer().playSound(SFX.Enemies.AirCrafts.PLANE_FLY, true);
    }
    ...
    protected void onDestroy(boolean doDestroySequence, boolean clearScheduler) {
        ...
        Main.getSoundPlayer().stopSound(SFX.Enemies.AirCrafts.PLANE_FLY, motorSound);
    }
