...
public abstract class Enemy extends GameCharacter implements Targeting<PlayerCharacter>, SkillAble {
    ...
    void playMotorSound() {
        if (motorSoundFileName != null) {
            motorSoundId = Main.getSoundPlayer().playSound(motorSoundFileName, true, 0);
        }
    }
    ...
    public void onUpdate(float delta) {
        ...
        if (motorSoundFileName != null) {
            if (motorSoundVolume < 1) {
                ...
                Main.getSoundPlayer().setVolume(motorSoundFileName, motorSoundId, motorSoundVolume);
            }
        }
    }
    ...
    protected void stopMotorSound() {
        if (motorSoundFileName != null) {
            Main.getSoundPlayer().stopSound(motorSoundFileName, motorSoundId);
        }
    }
