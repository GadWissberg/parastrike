...
public class Apache extends AirCraft {
    ...
    private void constructionFieldsInitialization() {
        atlas = Main.getAssetsManager().get(Assets.GFX.Sheets.InGame.Enemies.AirCrafts.APACHE_DATA_FILE);
    ...
    public float getDamageBySkill(int weapon) {
        int skill = Main.getPlayerStatsHandler().getSelectedLevelSkill().ordinal();
