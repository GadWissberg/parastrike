...
//
    ...
    public void saveSnapshot(final Image savingAnimation) {
        if (!Main.getGGS().isSignedIn()) return;
        ...
        open.addOnCompleteListener(new OnCompleteListener<SnapshotsClient.DataOrConflict<Snapshot>>() {
            ...
            public void onComplete(@NonNull Task<SnapshotsClient.DataOrConflict<Snapshot>> task) {
                try {
                    ...
                    Task<SnapshotMetadata> result = writeSnapshot(snapshot, SavedGame.serialize(Main.getPlayerStatsHandler().getPlayerStats()));
                ...
                public void onComplete(@NonNull Task<byte[]> task) {
                    ...
                    if (data != null) {
                        try {
                            ...
                            Main.getPlayerStatsHandler().applySavedGame(savedGame);
        ...
        mPlayersClient.getCurrentPlayer().addOnCompleteListener(new OnCompleteListener<Player>() {
            ...
            public void onComplete(@NonNull Task<Player> task) {
                if (task.isSuccessful()) {
                    ...
                    Main.getPlayerStatsHandler().setPlayerName(displayName);
                } else {
